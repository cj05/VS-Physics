...
class BoltzmanLattice{
    private:
         ...
         * Initialize the CFD
         *
         * @param Target GPU, Boundary array, Air default lattice
         */
        void init(Device device,int* boundaryIn,double* enviromentAir){
            ...
            this->Record = new Memory<double>(device,12);
            /**
             * records the data, [0-2] drag force [3-5] moment [6-8] COM position
             */
        ...
        /**
         * Calculates the air lattice structure with given parameters
         *
         * @param array to hold the data,airflow x, airflow y, air density
         * @return data
         */
    ...
    public:
        /**
         * BML Handling constructor, this one is a debug.
         */
        BoltzmanLattice(){
        ...
        /**
         * BML Handling constructor
         *
         * @param array detailing the boundary, airflow x, airflow y, air density
         */
         ...
         * BML Handling constructor
         *
         * @param array detailing the boundary, default air lattice node
         */
        ...
        /**
         * Fills in the non-exposed parts with 2
         */
        ...
        void tick(){
            ...
            Kernel tick_lattice(this->device, (this->Nx)*(this->Ny), "tick_lattice", *this->Lattice, *this->LatticeEnd,
                                *this->Size,*this->boundary,*this->weight,*this->dAir,*this->cOffset,*this->tMatrix,
                                *this->Record); // kernel that runs on the device
            this->cOffset->write_to_device();
            this->weight->write_to_device();
            this->tMatrix->write_to_device();
        ...
        //
        /**
         * Finds the total force acting on the object
         *
         *
         *
         * @return double array with [0-2] as force that is acted on (x,y,z) and [3-5] as moment that is acted on
         */
        double* CalcForce(){
            double output[6] = {};
